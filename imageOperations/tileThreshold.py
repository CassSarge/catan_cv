...
class TileThresholder:
	...
	def __init__(self, image, calibrate=False):
		...
		if calibrate:
			...
			self.autocalibrate()
		print(f"Origin: {self.origin}, Right: {self.delta_r},  Down Left: {self.delta_dl}, Down Right: {self.delta_dr}")
...
listOfKeyPoints = ["Centre of top row leftmost tile",
				"Centre of top row 4rd tile",
				"Centre of last row final tile",
				"Centre of last row first tile"
				"Please Press Esc"
]
